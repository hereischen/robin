# -*- coding: utf-8 -*-
# Generated by Django 1.9.9 on 2016-09-26 15:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('issue_state', models.PositiveSmallIntegerField(choices=[(0, 'CLOSED'), (1, 'OPEN'), (9, 'NOT FOUND')], default=1, verbose_name='issue state')),
                ('body', models.TextField(verbose_name='issue body')),
                ('pull_state', models.PositiveSmallIntegerField(choices=[(0, 'CLOSED'), (1, 'OPEN'), (9, 'NOT FOUND')], default=1, verbose_name='pull state')),
